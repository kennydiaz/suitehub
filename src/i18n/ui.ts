...
export const ui = {
  es: {
    ...
    'footer.tagline': 'SuiteHub es la plataforma de gestión empresarial para PYMEs en Panamá, USA, Venezuela, España y Colombia que quieren crecer con tecnología corporativa, sin la complejidad ni el costo.',
    ...
    'footer.madeIn':          'desde Panamá para el mundo',
  ...
  en: {
    ...
    'footer.tagline': 'SuiteHub is the business management platform for SMBs across Panama, USA, Venezuela, Spain, and Colombia that want enterprise-grade technology without the complexity or cost.',
    'footer.col.product': 'SuiteHub',
    ...
    'footer.madeIn':          'from Panama for the world',
