...
export const ui = {
  es: {
    ...
    'footer.copyright':       'Todos los derechos reservados. Operado en Panamá por PROOQ S.A., partner oficial.',
  ...
  en: {
    ...
    'footer.copyright':       'All rights reserved. Operated in Panama by PROOQ S.A., official partner.',
